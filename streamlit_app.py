...
#from snowflake.snowpark.context import get_active_session not needed when published in SniS
...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        search_on=pd_df.loc[pd_df['FUIT_NAME'] == fruit_chosen, 'SEARCH_ON'].iloc[0]
